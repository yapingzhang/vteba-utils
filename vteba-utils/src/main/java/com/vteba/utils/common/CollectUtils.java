...
import com.vteba.utils.ofbiz.MapComparator;
import com.vteba.utils.ofbiz.UtilGenerics;


public class CollectUtils {
    public static final BigDecimal ZERO_BD = BigDecimal.ZERO;
//    public static <V> Map<String, V> toMap(Object... objects) {
//        Map<String, V> maps = Maps.newHashMap();
//        if (objects != null) {
...
//    }
    ...
    public static <V, V1 extends V> Map<String, V> toMap(String name1, V1 value1) {
        return new CollectUtils.SimpleMap<V>(name1, value1);
    ...
    public static <V, V1 extends V, V2 extends V> Map<String, V> toMap(String name1, V1 value1, String name2, V2 value2) {
        return new CollectUtils.SimpleMap<V>(name1, value1, name2, value2);
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V> Map<String, V> toMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3) {
        return new CollectUtils.SimpleMap<V>(name1, value1, name2, value2, name3, value3);
    ...
    public static <V, V1 extends V, V2 extends V, V3 extends V, V4 extends V> Map<String, V> toMap(String name1, V1 value1, String name2, V2 value2, String name3, V3 value3, String name4, V4 value4) {
        return new CollectUtils.SimpleMap<V>(name1, value1, name2, value2, name3, value3, name4, value4);
    ...
    /** This is meant to be very quick to create and use for small sized maps, perfect for how we usually use CollectUtils.toMap */
